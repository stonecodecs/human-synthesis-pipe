...
export OUTPUT_PATH="/workspace/test_relit"
...
--light_lowres_denoise $LIGHT_LOWRES_DENOISE --light_bg_source $LIGHT_BG_SOURCE --step_size $STEP_SIZE --cropping 60 $FORCE_FLAG
